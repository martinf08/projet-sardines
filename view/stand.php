<main>
    <div id="header">
        ...
        <?php if (isset($_SESSION['user']) AND !empty($_SESSION['user'])): ?>
            <div id="sardines" style="background: #0cd18f;"><span class="bold"><?= $_SESSION['user']->getBalance() ?></span> <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
    ...
    <div id="fleche">cherche style flèche pour les autres pages</div>
