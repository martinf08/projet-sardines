...
INSERT INTO `user`(`nickname`, `email`, `avatar`, `identifier`, `account_creation_date`, `last_login`, `password`, `account_status`, `balance`, `admin`, `staff`) VALUES ('bienni','bienni@troll.net',null,'bb08',NOW(),NOW(),'098f6bcd4621d373cade4e832627b4f6',1,0,1,0);